...
public class ExpandableListAdapter extends BaseExpandableListAdapter{
    ...
    private SparseArray<ExpandableListParent> objects;

    private SparseIntArray idPositions;
    public ArrayList<Integer> selectedIds = new ArrayList<>();

    public ExpandableListAdapter(Context context, SparseArray<ExpandableListParent> objects, SparseIntArray idPositions) {
    ...
    public SparseArray<ExpandableListParent> getParent() {
        return objects;
    }
    ...
    public View getGroupView(int parentPosition, boolean b, View view, ViewGroup viewGroup) {
        ...
        ExpandableListParent obj = objects.get(parentPosition);
