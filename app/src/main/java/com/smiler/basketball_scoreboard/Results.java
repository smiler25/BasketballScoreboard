...
public class Results {
    ...
    public Results(String hName, String gName) {
        this.hName = hName;
        this.gName = gName;
    }
    public Results(String hName, String gName, int hScore, int gScore) {
        this.hName = hName;
        this.gName = gName;
        this.hScore = hScore;
        this.gScore = gScore;
    ...
    public Results(String hName, String gName, int hScore, int gScore,
                   ArrayList<Integer>hScorePeriods, ArrayList<Integer>gScorePeriods, boolean complete) {
        this.hName = hName;
        this.gName = gName;
        this.hScore = hScore;
        this.gScore = gScore;
